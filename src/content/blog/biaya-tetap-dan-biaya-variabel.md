...
takeaways:
  ...
  - "Biaya variabel bergerak mengikuti produksi, penjualan, atau penggunaan tertentu sehingga perlu dibaca per unit atau aktivitas."
  - "Kelompokkan biaya dengan aturan yang sama agar laporan dan titik impas dapat dibandingkan."
faqs:
  - question: "Apa contoh biaya tetap?"
    answer: "Contohnya dapat mencakup sewa tertentu, langganan, atau gaji tetap sesuai perjanjian. Periksa apakah biaya tersebut benar-benar tidak berubah dalam periode yang dianalisis."
  - question: "Apa contoh biaya variabel?"
...
| --- | --- | --- |
| Tetap | Sewa bulanan tertentu | Apakah jumlahnya sama dalam periode ini meski unit terjual berubah? |
| Variabel | Bahan dan kemasan per produk | Apakah totalnya bertambah saat lebih banyak produk dibuat atau dijual? |
...
Biaya tetap biasanya dibaca per periode, misalnya per bulan. Biaya variabel sering dibaca per unit atau per transaksi. Saat menghitung titik impas, gunakan periode yang sama. Membagi sewa bulanan dengan biaya kemasan satu hari tanpa menjelaskan periode akan membuat hasil sulit dipakai.

Untuk biaya produk, mulailah dari komponen yang dapat ditelusuri. Panduan [menghitung HPP produk](/blog/cara-menghitung-hpp-produk/) membantu menghubungkan bahan dan kemasan dengan hasil produksi. Setelah itu, [titik impas usaha](/blog/cara-menghitung-titik-impas-usaha/) menggunakan selisih harga dan biaya variabel untuk membaca batas minimum penjualan menurut asumsi yang dipilih.

## Catat biaya yang bersifat campuran

Tidak semua biaya mudah dimasukkan ke satu kelompok. Tagihan listrik dapat memiliki beban dasar dan tambahan penggunaan. Gaji dapat tetap sampai jam lembur tertentu. Pengiriman mungkin berbeda menurut jumlah pesanan atau wilayah.
