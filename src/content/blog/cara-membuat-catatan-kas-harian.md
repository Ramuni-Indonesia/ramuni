---
title: "Cara Membuat Catatan Kas Harian UMKM"
description: "Panduan membuat catatan kas harian untuk UMKM: saldo awal, uang masuk, uang keluar, bukti transaksi, dan pemeriksaan saldo akhir."
dek: "Catatan kas harian membantu mengetahui uang yang benar-benar bergerak. Pisahkan dari omzet dan simpan bukti agar setiap perubahan dapat diperiksa."
cover: "/website-original/blog/generated/cara-membuat-catatan-kas-harian.webp"
coverAlt: "Pemilik toko memeriksa uang kas, struk, dan buku catatan kas harian"
coverWidth: 640
coverHeight: 360
...
readingTime: "7 menit"
takeaways:
  - "Mulai dari saldo awal, lalu catat setiap penerimaan dan pengeluaran dengan waktu serta bukti yang dapat ditelusuri."
  - "Kas berbeda dari omzet karena penjualan dapat dibayar pada waktu lain dan uang masuk dapat berasal dari sumber selain penjualan."
  - "Bandingkan saldo catatan dengan uang fisik atau rekening yang relevan pada akhir periode."
faqs:
  - question: "Apa saja isi catatan kas harian?"
    answer: "Minimal catat tanggal, keterangan, uang masuk, uang keluar, saldo berjalan, metode pembayaran, dan bukti atau penanggung jawab transaksi."
  - question: "Apakah omzet sama dengan kas masuk?"
    answer: "Tidak. Omzet menunjukkan nilai penjualan, sedangkan kas menunjukkan uang yang benar-benar diterima atau dikeluarkan. Penjualan kredit dan pembayaran tertunda membuat keduanya berbeda."
  - question: "Seberapa sering kas harus direkonsiliasi?"
    answer: "Untuk kas tunai, pemeriksaan harian sering membantu. Rekening atau metode pembayaran lain dapat dicocokkan sesuai frekuensi transaksi dan proses usaha."
sources:
  - title: "PSAK 207: Laporan Arus Kas"
    publisher: "Ikatan Akuntan Indonesia"
    url: "https://knowledge.iaiglobal.or.id/detail_workshop/7668736b30385a456963426d756350746437566442686c4b704e6f2b53464c6a6648386f552b714f67503772486d66586b43462f5258446b45596274662b774c543137496873304c72556d4d68467967773564466941477a4b7a2f6d5a4b342b62754964704472467a38493366683852"
...
Mulailah dengan format sederhana yang dapat dijaga setiap hari.

| Tanggal | Keterangan | Masuk | Keluar | Saldo | Bukti |
| --- | --- | ---: | ---: | ---: | --- |
| 9 Agustus | Saldo awal kas | Rp500.000 | - | Rp500.000 | Serah-terima sebelumnya |
| 9 Agustus | Penjualan tunai | Rp750.000 | - | Rp1.250.000 | Rekap kasir |
| 9 Agustus | Belanja bahan | - | Rp200.000 | Rp1.050.000 | Nota pembelian |

## Pisahkan sumber uang dengan jelas

Jangan menggunakan keterangan umum seperti “uang masuk”. Tuliskan apakah uang berasal dari penjualan tunai, pelunasan piutang, setoran pemilik, atau sumber lain. Demikian pula, tulis apakah uang keluar untuk belanja barang, pengembalian pelanggan, biaya operasional, atau pengambilan pribadi yang telah dicatat.
...
Contoh catatan: “Saldo kas seharusnya Rp1.050.000, fisik Rp1.000.000; selisih Rp50.000. Periksa transaksi tunai pukul 16.00.” Catatan ini memberi tim titik awal untuk memeriksa bukti, bukan menganggap selisih sebagai hal biasa.

## Hindari mencampur kas usaha dan uang pribadi

Bila pemilik mengambil uang dari laci kas atau menyetor uang pribadi, catat sebagai peristiwa tersendiri. Pencampuran membuat usaha sulit membaca kebutuhan operasional serta hasil sebenarnya. Untuk memahami konteksnya, baca [perbedaan omzet, laba, dan arus kas](/blog/perbedaan-omzet-laba-dan-arus-kas/).

Catatan kas harian tidak harus menjadi laporan rumit. Bila dicatat konsisten dan didukung bukti, ia memberi dasar untuk laporan yang lebih baik dan membantu usaha mengambil tindakan sebelum selisih kecil menjadi masalah besar. Hasilnya dapat kemudian dibaca bersama [laporan laba rugi sederhana](/blog/laporan-laba-rugi-sederhana-umkm/) tanpa menyamakan uang tersedia dengan laba.

Mulailah dengan satu lokasi penyimpanan yang jelas untuk uang dan satu format yang sama untuk semua transaksi. Jika ada perubahan proses, misalnya membuka kanal pembayaran baru atau menunjuk kasir baru, lakukan contoh penutupan hari bersama pada minggu pertama. Tulis siapa yang boleh menyetujui koreksi, siapa yang menyimpan bukti, dan kapan catatan dianggap selesai. Tinjau proses ini setelah beberapa hari kerja, terutama ketika volume transaksi meningkat dan ada pengeluaran tidak rutin. Dokumentasikan keputusan perbaikan, tanggalnya, dan dampak yang ingin diukur pada minggu berikutnya secara rutin. Batas peran sederhana mengurangi risiko satu orang harus mengingat seluruh transaksi tanpa dukungan bukti.
