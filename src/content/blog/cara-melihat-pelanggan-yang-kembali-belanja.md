...
updateSummary: "Terbit awal dengan definisi pelanggan kembali, batas privasi, dan contoh pembacaan kelompok."
related:
...
1. Periode analisis, misalnya 90 hari.
2. Transaksi yang dihitung, misalnya hanya transaksi selesai.
3. Cara mengenali pelanggan, misalnya ID pelanggan yang dibuat dengan pemberitahuan yang sesuai.
...
Baca [data pelanggan yang perlu dicatat UMKM](/blog/data-pelanggan-yang-perlu-dicatat-umkm/) sebelum menambah kolom baru. Prinsipnya sederhana: kumpulkan data yang punya tujuan jelas, batasi akses, dan jangan menyimpan informasi hanya karena mungkin berguna suatu hari nanti.

Rujuk teks resmi [Undang-Undang Pelindungan Data Pribadi](https://peraturan.bpk.go.id/Details/229798/uu-no-27-tahun-2022) dan mintalah tinjauan hukum untuk penerapan pada proses usaha Anda.
...
[Modul pelanggan RAMUNI](/produk/pelanggan/) menggambarkan bagaimana catatan pelanggan dapat dihubungkan dengan riwayat transaksi. Penggunaan nyata tetap harus mengikuti status fitur, hak akses, dan kebijakan privasi yang berlaku.
...
1. Periksa apakah data transaksi lengkap.
2. Tinjau apakah kelompok memiliki izin komunikasi pemasaran.
3. Nilai apakah layanan atau stok pada periode tersebut bermasalah.
4. Susun pesan yang relevan tanpa mengungkap informasi sensitif.
5. Hormati pilihan berhenti dan catat hasil tanpa memasukkan isi percakapan ke analitik pemasaran.
