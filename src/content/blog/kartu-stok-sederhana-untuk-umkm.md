---
title: "Kartu Stok Sederhana untuk UMKM"
description: "Panduan membuat kartu stok sederhana untuk mencatat barang masuk, keluar, dan saldo sehingga pergerakan persediaan lebih mudah diperiksa."
dek: "Kartu stok tidak perlu rumit. Yang penting, setiap perubahan memiliki tanggal, satuan, alasan, dan saldo yang bisa ditelusuri kembali."
cover: "/website-original/blog/generated/kartu-stok-sederhana-untuk-umkm.webp"
coverAlt: "Pemilik toko mencatat barang masuk, keluar, dan saldo pada kartu stok di depan rak persediaan"
coverWidth: 640
coverHeight: 360
...
readingTime: "7 menit"
takeaways:
  - "Satu kartu stok sebaiknya mewakili satu produk dan satu satuan yang konsisten."
  - "Catat tanggal, sumber perubahan, jumlah masuk atau keluar, serta saldo setelah perubahan."
  - "Kartu stok membantu pemeriksaan, tetapi tetap perlu dibandingkan dengan kondisi fisik secara berkala."
faqs:
  - question: "Kolom apa saja yang diperlukan dalam kartu stok?"
    answer: "Minimal gunakan tanggal, keterangan atau sumber transaksi, jumlah masuk, jumlah keluar, saldo, serta penanda orang atau bukti yang dapat ditelusuri."
  - question: "Apakah satu kartu stok boleh untuk beberapa produk?"
    answer: "Sebaiknya tidak. Gabungan beberapa produk membuat satuan, saldo, dan sumber pergerakan sulit diperiksa."
  - question: "Apakah kartu stok sama dengan stok fisik?"
    answer: "Tidak. Kartu stok adalah catatan pergerakan. Stok fisik adalah jumlah yang benar-benar ditemukan saat pemeriksaan. Keduanya perlu dibandingkan secara berkala."
sources:
  - title: "PSAK Umum: Persediaan"
    publisher: "Ikatan Akuntan Indonesia"
    url: "https://web.iaiglobal.or.id/PSAK-Umum/16"
    accessedAt: 2026-08-09
    note: "Rujukan umum mengenai persediaan. Format kartu dalam artikel adalah contoh operasional sederhana, bukan format akuntansi wajib."
disclaimer: "Format contoh perlu disesuaikan dengan satuan produk, proses penerimaan, kebijakan koreksi, dan kebutuhan usaha."
updateSummary: "Naskah baru tentang format kartu stok dan pemeriksaan saldo."
related:
...
Untuk memulai, buat satu kartu untuk satu produk dan satu satuan. Jangan mencampur “dus”, “pak”, dan “unit” tanpa aturan konversi. Jika satu dus berisi 12 unit, tulis aturan itu di tempat yang jelas sebelum ada transaksi.

## Gunakan kolom minimum yang bisa diperiksa

| Tanggal | Keterangan | Masuk | Keluar | Saldo | Bukti atau penanggung jawab |
| --- | --- | ---: | ---: | ---: | --- |
| 8 Agustus | Penerimaan pemasok | 24 | - | 24 | Nota penerimaan |
| 8 Agustus | Penjualan | - | 5 | 19 | Rekap kasir |
| 9 Agustus | Barang rusak | - | 1 | 18 | Catatan pemeriksaan |

Saldo tidak boleh ditulis hanya di akhir hari tanpa penjelasan perubahan yang membentuknya. Dengan contoh di atas, tim bisa melihat mengapa jumlah berkurang dan bukti apa yang perlu dibuka bila ada pertanyaan.

## Samakan produk dan satuan sebelum mencatat

Nama produk yang hampir sama sering membuat kartu stok tidak dapat dipercaya. “Teh lemon”, “Teh Lemon 250 ml”, dan “Teh Lemon botol” harus dibedakan bila memang barangnya berbeda. Gunakan SKU atau penanda internal setelah data produk rapi; panduan [merapikan data produk dan SKU](/blog/cara-merapikan-data-produk-dan-sku/) dapat membantu menetapkan aturan dasarnya.

Jika pemasok mengirim dalam dus sementara toko menjual per unit, tentukan kapan konversi dicatat. Misalnya, 2 dus x 12 unit masuk sebagai 24 unit. Jangan menulis dua dus pada kolom masuk lalu mengurangi lima unit pada kolom keluar tanpa menjelaskan sisa satuannya.

## Catat sumber setiap pergerakan

Barang masuk dapat berasal dari penerimaan pemasok, retur pelanggan yang layak jual, atau perpindahan antar lokasi. Barang keluar dapat berasal dari penjualan, bahan produksi, barang rusak, retur ke pemasok, atau koreksi yang disetujui. Keterangan singkat membuat saldo lebih mudah ditelusuri.
