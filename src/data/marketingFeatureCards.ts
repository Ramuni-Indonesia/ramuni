...
import { featureDetails, type CapabilityStatus } from './commercial';

// Feature detail data is the single source of truth for availability labels;
// card collections consume it instead of drifting when a release status
// changes.
const featureStatusBySlug = Object.fromEntries(
  featureDetails.map((feature) => [feature.slug, feature.status]),
...
export const marketingFeatureCards: readonly MarketingFeatureCard[] = [
  {
    ...
    status: featureStatusBySlug['ai-copilot'],
  },
  {
    ...
    status: featureStatusBySlug['profit-intelligence'],
  },
  {
    ...
    status: featureStatusBySlug.omnichannel,
  },
  {
    ...
    status: featureStatusBySlug['web-builder'],
  },
  {
    ...
    status: featureStatusBySlug['knowledge-os'],
  },
];
