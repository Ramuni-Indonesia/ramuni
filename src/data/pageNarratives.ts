...
export const productNarratives: Record<string, ProductNarrative> = {
  'asisten-ai': {
    ...
    featureHeading: 'Tanya dengan bahasa sehari-hari. Tetap tahu batas jawabannya.',
  ...
  pelanggan: {
    ...
    roleHeading: 'Akses pelanggan dibatasi sesuai kebutuhan pekerjaan.',
  ...
  integrasi: {
    ...
    featureHeading: 'Setiap jalur data menyebut cara kerja dan batasnya.',
...
export const solutionNarratives: Record<string, SolutionNarrative> = {
  ...
  'pahami-pelanggan': {
    ...
    moduleHeading: 'Riwayat, transaksi, dan jawaban dibaca dalam batas izin.',
    ...
    closing: 'Pahami pola pelanggan dengan batas privasi yang jelas.',
  },
