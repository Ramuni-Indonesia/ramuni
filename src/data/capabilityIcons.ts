...
const navigationIconKeys: Record<string, string> = {
  ...
  '/generator/lembar-stok-harian': 'nav-resource-template',
  '/kalkulator': 'nav-tool-profit',
  '/kalkulator/laba-usaha': 'nav-tool-profit',
  '/kalkulator/hpp': 'nav-tool-cost',
  '/kalkulator/harga-jual': 'nav-tool-cost',
  '/kalkulator/hpp-per-porsi': 'nav-tool-cost',
  '/kalkulator/margin-laba-kotor': 'nav-tool-profit',
  '/kalkulator/titik-impas': 'nav-tool-profit',
  '/kalkulator/arus-kas-bersih': 'nav-solution-cash',
  '/kalkulator/nilai-transaksi-rata-rata': 'nav-tool-profit',
  '/kalkulator/perubahan-omzet': 'nav-tool-profit',
  '/kalkulator/target-penjualan': 'nav-tool-profit',
