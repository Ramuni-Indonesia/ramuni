...
export const marketingDashboardContexts: Record<MarketingDashboardContextKey, MarketingDashboardContext> = {
  ...
  ai: {
    ...
    subtitle: 'Pertanyaan, sumber data, dan dasar jawaban ditampilkan sebelum pengguna mengambil keputusan.',
    ...
    metrics: [
      ...
      { label: 'Dasar jawaban', value: 'Terlihat', note: 'Dapat diperiksa', tone: 'neutral' },
    ],
    bars: [32, 52, 78, 64, 46, 58, 72],
    segments: ['Tanya', 'Cari', 'Cocokkan', 'Jawab', 'Periksa', 'Bukti', 'Arah'],
